    ...
    >
        <SwiperSlide className='flex items-center justify-center h-full py-1'>
            <motion.div initial={{opacity : 0, x : 30}} animate={{opacity : 1, x : 0 ,transition : {duration : 0.5}}} className='w-full h-full flex items-start justify-start group relative'>
                <Link className='w-full h-full flex items-center justify-start py-4 px-5 rounded-xl bg-white transition-all shadow-lg max-sm:borderc max-sm:border-white max-sm:hover:border-primary'> 
        ...
        <SwiperSlide className='flex items-center justify-center h-full py-1'>
            <motion.div initial={{opacity : 0, x : 30}} animate={{opacity : 1, x : 0, transition : {duration : 0.5}}} className='w-full h-full flex items-start justify-start group relative'>
                <Link className='w-full h-full flex items-center justify-start py-4 px-5 rounded-xl bg-white shadow-lg max-sm:border max-sm:border-white max-sm:hover:border-primary'> 
