...
function ProductCard({ product }) {
  ...
  return (
    <motion.div initial={{translateY : "25px"}} animate={{translateY : "0", opacity : "1"}} className='w-56 h-70 max-sm:w-40 max-sm:h-50 bg-white flex flex-col items-center justify-start ml-3 rounded-sm overflow-hidden shadow-md group transition-all opacity-0 relative p-2'>
        ...
        <h3 className='text-dull max-sm:text-[10px]'>
            {product.product_name}
            <span className='flex items-center justify-between w-full mt-2'>

            <Link to={`/store-details/${product.product_store.id}`} className='text-gray-500 text-xs transition-all hover:text-primary'>{product.product_store.store_name}</Link>
            <hr className='border border-gray-200 w-2' />
        ...
        <div className='w-full absolute flex items-center justify-center font-product max-sm:mt-6 text-primary font-semibold tracking-wider -bottom-12 group-hover:bottom-0 transition-all'>

        {
                product.is_product_in_cart === "unauthenticated" ? (
                    ...
                    <Link to={"/user-login"} className='w-1/3 h-12 hover:scale-105 transition-all text-secondary text-sm flex items-center justify-center'>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={windowDimensions.width <= 450 ? 15 : 24} height={windowDimensions.width <= 450 ? 15 : 24} color={"#006964"} fill={"none"}>
                    ...
                    product.is_product_in_cart ? (
                        ...
                        <Link to={"/user-cart"} className='w-1/3 h-12 hover:scale-105 transition-all text-secondary text-sm flex items-center justify-center' title='View In Cart'>
                            <svg xmlns="http://www.w3.org/2000/svg" width={windowDimensions.width <= 450 ? 15 : 24} height={windowDimensions.width <= 450 ? 15 : 24} viewBox="0 0 24 24" fill="none" className="injected-svg" data-src="https://cdn.hugeicons.com/icons/shopping-basket-02-solid-rounded.svg" xmlnsXlink="http://www.w3.org/1999/xlink" role="img" color="#006964">
            ...
            
            {
                product.is_product_in_wishlist === 'unauthenticated' ? (
                    ...
                    <Link to={'/user-login'} className='w-1/3 h-12 hover:scale-105 transition-all text-secondary text-sm flex items-center justify-center border-primary'>
                        <svg xmlns="http://www.w3.org/2000/svg" width={windowDimensions.width <= 450 ? 15 : 24} height={windowDimensions.width <= 450 ? 15 : 24} viewBox="0 0 24 24" fill="none" class="injected-svg" data-src="https://cdn.hugeicons.com/icons/heart-add-stroke-standard.svg" xmlns:xlink="http://www.w3.org/1999/xlink" role="img" color="#006964">
                    ...
                    product.is_product_in_wishlist ? (
                        ...
                        <Link to={"/user-wishlist"} className='w-1/3 h-12 hover:scale-105 transition-all text-secondary text-sm flex items-center justify-center border-primary' title="View In Cart">
                            <svg xmlns="http://www.w3.org/2000/svg" width={windowDimensions.width <= 450 ? 15 : 24} height={windowDimensions.width <= 450 ? 15 : 24} viewBox="0 0 24 24" fill="none" className="injected-svg" data-src="https://cdn.hugeicons.com/icons/favourite-solid-standard.svg" xmlnsXlink="http://www.w3.org/1999/xlink" role="img" color="#006964">
