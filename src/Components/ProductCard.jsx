...
function ProductCard({ product }) {
  ...
  return (
    <motion.div initial={{translateY : "25px"}} animate={{translateY : "0", opacity : "1"}} className='w-56 h-70 bg-white flex flex-col items-center justify-start ml-3 rounded-sm overflow-hidden shadow-md group transition-all opacity-0 relative p-2'>
        ...
        <div className='w-full absolute flex items-center justify-center font-product text-primary font-semibold tracking-wider -bottom-12 group-hover:bottom-0 transition-all'>
