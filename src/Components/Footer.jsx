  ...
  return (
    ...
    <footer className='w-full h-100 bg-[#eaeaea] border-2 border-gray-300 flex flex-col items-center justify-center mt-10 rounded-t-3xl overflow-hidden'>
        ...
        <div className='w-full h-full flex items-start justify-start'>
            ...
            <div className='w-1/3 h-full flex flex-col items-center justify-start p-8'>

                <h2 className='text-2xl font-product tracking-wide font-semibold text-primary'>Contact Us</h2>

                <div className='flex flex-col items-start justify-start font-product'>
            ...
            <div className='w-1/3 h-full flex flex-col items-center justify-start p-8'>
                ...
                <div className='flex flex-col items-center justify-start mt-10 text-primary font-product'>
                    ...
                    <Link to={'/supprot/buy-the-best'} className='px-2 border-x-2 border-transparent transition-all hover:border-primary mt-4 tracking-wide hover:tracking-normal'>Buy The Best</Link>

                    <Link to={'/supprot/privacy-policy'} className='px-2 border-x-2 border-transparent transition-all hover:border-primary mt-4 tracking-wide hover:tracking-normal'>Privacy Policy</Link>

                    <Link to={'/supprot/terms-of-use'} className='px-2 border-x-2 border-transparent transition-all hover:border-primary mt-4 tracking-wide hover:tracking-normal'>Terms Of Use</Link>
            ...
            <div className='w-1/3 h-full flex flex-col items-center justify-start p-8'>
                ...
                <h2 className='text-2xl font-product tracking-wide text-primary font-semibold'>Follow Us</h2>

                <div className='flex flex-col items-center justify-start mt-10 text-white'>
                    ...
                    <div className='flex items-center justify-between'>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 48 48" className='ml-3'>
