    ...
    <footer className='w-full h-100 bg-[#eaeaea] border-2 border-gray-300 flex flex-col items-center justify-center mt-10 rounded-t-3xl overflow-hidden'>
        ...
        <div className='w-full h-full flex items-start justify-start max-sm:flex-col'>
            ...
            <div className='w-1/3 h-full flex flex-col items-center justify-start p-8 max-sm:w-full max-sm:p-4 max-sm:mt-3'>
                ...
                <h2 className='text-2xl font-product tracking-wide font-semibold text-primary'>Contact Us</h2>

                <div className='flex min-sm:flex-col items-start justify-start font-product max-sm:w-full max-sm:justify-around'>
                    <div className='flex items-center justify-center mt-10 max-sm:flex-col'>

                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={32} height={32} color={"#006964"} fill={"none"}>
                    ...
                    <div className='flex items-center justify-center mt-10 max-sm:flex-col max-sm:justify-center'>
                        ...
                        <div className='flex flex-col items-start justify-start ml-4 max-sm:justify-center max-sm:items-center'>
            ...
            <div className='w-1/3 h-full flex flex-col items-center justify-start p-8 max-sm:w-full max-sm:p-4'>
                ...
                <div className='flex min-sm:flex-col items-center justify-start mt-10 text-primary font-product max-sm:justify-around max-sm:mt-6'>

                    <Link to={'/supprot/seller-tutorial'} className='px-2 border-x-2 border-transparent transition-all hover:border-primary tracking-wide hover:tracking-normal'>Seller Tutorial</Link>

                    <Link to={'/supprot/buy-the-best'} className='px-2 border-x-2 border-transparent transition-all hover:border-primary min-sm:mt-4 tracking-wide hover:tracking-normal'>Buy The Best</Link>

                    <Link to={'/supprot/privacy-policy'} className='px-2 border-x-2 border-transparent transition-all hover:border-primary min-sm:mt-4 tracking-wide hover:tracking-normal'>Privacy Policy</Link>

                    <Link to={'/supprot/terms-of-use'} className='px-2 border-x-2 border-transparent transition-all hover:border-primary min-sm:mt-4 tracking-wide hover:tracking-normal'>Terms Of Use</Link>
            ...
            <div className='w-1/3 h-full flex flex-col items-center justify-start p-8 max-sm:p-2 max-sm:w-full'>
                ...
                <div className='flex min-sm:flex-col items-center justify-start mt-10 text-white max-sm:mt-0 max-sm:justify-center max-sm:w-full'>
                    ...
                    <div className='flex items-center justify-between max-sm:w-1/3 max-sm:justify-around max-sm:scale-80'>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 48 48" className='ml-3 max-sm:ml-0'>
                    ...
                    <div className='flex items-center justify-between mt-5 max-sm:mt-0 max-sm:w-1/3 max-sm:justify-around max-sm:scale-80'>
