                    ...
                    <div className="w-full flex flex-col items-center justify-start h-full">
                      ...
                      <div className="w-full h-6/10 flex flex-wrap items-start justify-between">
                        ...
                        <div className="w-1/2 h-full flex flex-col items-center justify-around">
                          ...
                          <button type='button' className="w-7/10 flex items-center justify-start">Beauty & Personal Care</button>
                        ...
                        <p className="text-xl font-lilita w-full flex items-center justify-center py-2">Vend<span className="text-primary">ezy</span></p>
